...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO exercicios_usuarios (categoria, nome, series, repeticoes, TEMPO, usuario_id)
            SELECT ?, nome, ?, ?, ?, ?, id FROM exercicios WHERE id = ?";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("siiisi", $categoria, $series, $repeticoes, $TEMPO, $usuarioId, $exercicioId);
    $stmt->execute();
    $stmt->close();
}
